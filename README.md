...
- signButton(회원가입 버튼) 클릭시 처리 : 
  ...
  * 회원가입 조건에 모두 부합한다면 회원정보를 다음과 같은 방식으로 프레퍼런스에 저장
    ...
    ```
        ...
        editor.putInt("index",index); // "index" : 1,2,.... 
...
<img width="237" alt="image" src="https://user-images.githubusercontent.com/84428520/199242797-b9f090f5-8d83-4f7a-948f-51c591a463ed.png">
